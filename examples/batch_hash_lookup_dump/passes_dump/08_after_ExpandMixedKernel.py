...
class BatchHashLookup:
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def batch_hash_lookup_incore_1(self, hash_pool_0: pl.Tensor[[64, 128, 32], pl.INT32], probe_0: pl.Scalar[pl.INDEX], search_key_0: pl.Tensor[[1024, 64, 32], pl.INT32], ti_0: pl.Scalar[pl.INDEX], ti_iter_1: pl.Scalar[pl.INDEX], value_ptr_out_2: pl.Tensor[[1024, 64, 32], pl.INT32], value_ptr_out_iter_6: pl.Tensor[[1024, 64, 32], pl.INT32]) -> tuple[pl.Scalar[pl.INDEX], pl.Scalar[pl.INDEX], pl.Tensor[[1024, 64, 32], pl.INT32]]:
        for b_3, (ti_iter_3, value_ptr_out_iter_8) in pl.parallel(0, 1024, 32, init_values=(ti_iter_1, value_ptr_out_iter_6)):
            for ti_5, (value_ptr_out_iter_10,) in pl.parallel(0, 64, 32, init_values=(value_ptr_out_iter_8,)):
                ...
                value_ptr_out_11: pl.Tensor[[1024, 64, 32], pl.INT32] = pl.yield_(value_ptr_out_12)
    ...
    def batch_hash_lookup(self, search_key_0: pl.Tensor[[1024, 64, 32], pl.INT32], hash_table_size_0: pl.Tensor[[64, 32], pl.INT32], hash_base_ptr_0: pl.Tensor[[64, 32], pl.INT32], hash_pool_0: pl.Tensor[[64, 128, 32], pl.INT32], value_ptr_out_0: pl.Tensor[[1024, 64, 32], pl.INT32]) -> pl.Tensor[[1024, 64, 32], pl.INT32]:
        ...
        for probe_0, (b_iter_1, ti_iter_1, value_ptr_out_iter_6) in pl.range(0, 8, 1, init_values=(b_0, ti_0, value_ptr_out_2)):
            ...
            value_ptr_out_9: pl.Tensor[[1024, 64, 32], pl.INT32] = ret[2]
