    ...
    class Qwen3Scope1:
        ...
        def qwen3_scope1(
            ...
            for b0 in pl.parallel(0, batch, BATCH_TILE):
                ...
                for ob0 in pl.spmd(32, name_hint="q_proj"):     # q_out_blocks=128 (spmd reduced from 128 to 32)
                    for j in pl.range(4):
                        ob = ob0*4 + j
                        q0 = ob * Q_OUT_CHUNK
                ...
                for ob0 in pl.spmd(4, name_hint="kv_proj"):    # kv_out_blocks=16 (spmd reduced from 16 to 4)
                    for j in pl.range(4):
                        ob = ob0*4 + j
                        kv0 = ob * KV_OUT_CHUNK
                        ...
                        v_acc = pl.matmul_acc(v_acc, tile_a_k1, tile_wv_1)
