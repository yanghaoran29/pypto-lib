...
class Qwen3SingleLayerDecode:
    ...
    def qwen3_decode_layer(self, hidden_states_0: pl.Tensor[[16, 5120], pl.BFLOAT16], cache_pos_0: pl.Tensor[[16], pl.INT32], rope_cos_0: pl.Tensor[[4096, 128], pl.FP32], rope_sin_0: pl.Tensor[[4096, 128], pl.FP32], k_cache_0: pl.Tensor[[524288, 128], pl.BFLOAT16], v_cache_0: pl.Tensor[[524288, 128], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 5120], pl.FP32], wq_0: pl.Tensor[[5120, 5120], pl.BFLOAT16], wk_0: pl.Tensor[[5120, 1024], pl.BFLOAT16], wv_0: pl.Tensor[[5120, 1024], pl.BFLOAT16], wo_0: pl.Tensor[[5120, 5120], pl.BFLOAT16], post_rms_weight_0: pl.Tensor[[1, 5120], pl.FP32], w_gate_0: pl.Tensor[[5120, 25600], pl.BFLOAT16], w_up_0: pl.Tensor[[5120, 25600], pl.BFLOAT16], w_down_0: pl.Tensor[[25600, 5120], pl.BFLOAT16], out_0: pl.Tensor[[16, 5120], pl.BFLOAT16]) -> pl.Tensor[[16, 5120], pl.BFLOAT16]:
        ...
        with pl.auto_incore():
            ...
            for kb_0, (sq_sum_iter_2,) in pl.parallel(0, 40, 1, init_values=(sq_sum_1,), chunk=4):
                k0_0: pl.Scalar[pl.INDEX] = kb_0 * 128
                x_chunk_0: pl.Tensor[[16, 128], pl.FP32] = pl.tensor.cast(pl.tensor.view(hidden_states_0, [16, 128], [0, k0_0]), target_type=pl.FP32, mode=2)
                sq_sum_4: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.add(sq_sum_iter_2, pl.tensor.row_sum(pl.tensor.mul(x_chunk_0, x_chunk_0)))
                sq_sum_3: pl.Tensor[[16, 1], pl.FP32] = pl.yield_(sq_sum_4)
            inv_rms_0: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.rsqrt(pl.tensor.add(pl.tensor.mul(sq_sum_3, 0.000195313), 1e-06))
            ...
            for kb_1, (k0_iter_1, k_proj_acc_iter_2, q_proj_acc_iter_2, v_proj_acc_iter_2, x_chunk_iter_1) in pl.range(0, 40, 1, init_values=(k0_0, k_proj_acc_1, q_proj_acc_1, v_proj_acc_1, x_chunk_0)):
                ...
                normed_0: pl.Tensor[[16, 128], pl.FP32] = pl.tensor.col_expand_mul(pl.tensor.row_expand_mul(x_chunk_3, inv_rms_0), gamma_0)
                normed_bf16_0: pl.Tensor[[16, 128], pl.BFLOAT16] = pl.tensor.cast(normed_0, target_type=pl.BFLOAT16, mode=2)
                for ob_0, (k_proj_acc_iter_4, q_proj_acc_iter_4, v_proj_acc_iter_4) in pl.parallel(0, 80, 1, init_values=(k_proj_acc_iter_2, q_proj_acc_iter_2, v_proj_acc_iter_2), chunk=8):
                    if ob_0 < 80:
                        q0_0: pl.Scalar[pl.INDEX] = ob_0 * 64
                        q_prev_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.view(q_proj_acc_iter_4, [16, 64], [0, q0_0])
                        wq_chunk_0: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.view(wq_0, [128, 64], [k0_3, q0_0])
                        q_next_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.add(q_prev_0, pl.tensor.matmul(normed_bf16_0, wq_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False))
                        q_proj_acc_6: pl.Tensor[[16, 5120], pl.FP32] = pl.tensor.assemble(q_proj_acc_iter_4, q_next_0, [0, q0_0])
                        q_proj_acc_7: pl.Tensor[[16, 5120], pl.FP32] = pl.yield_(q_proj_acc_6)
                    else:
                        q_proj_acc_7: pl.Tensor[[16, 5120], pl.FP32] = pl.yield_(q_proj_acc_iter_4)
                    if ob_0 < 16:
                        kv0_0: pl.Scalar[pl.INDEX] = ob_0 * 64
                        k_prev_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.view(k_proj_acc_iter_4, [16, 64], [0, kv0_0])
                        v_prev_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.view(v_proj_acc_iter_4, [16, 64], [0, kv0_0])
                        ...
                        k_next_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.add(k_prev_0, pl.tensor.matmul(normed_bf16_0, wk_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False))
                        v_next_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.add(v_prev_0, pl.tensor.matmul(normed_bf16_0, wv_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False))
                        k_proj_acc_6: pl.Tensor[[16, 1024], pl.FP32] = pl.tensor.assemble(k_proj_acc_iter_4, k_next_0, [0, kv0_0])
                        v_proj_acc_6: pl.Tensor[[16, 1024], pl.FP32] = pl.tensor.assemble(v_proj_acc_iter_4, v_next_0, [0, kv0_0])
                        k_proj_acc_7, v_proj_acc_7 = pl.yield_(k_proj_acc_6, v_proj_acc_6)
                    else:
                        k_proj_acc_7, v_proj_acc_7 = pl.yield_(k_proj_acc_iter_4, v_proj_acc_iter_4)
                    k_proj_acc_5, q_proj_acc_5, v_proj_acc_5 = pl.yield_(k_proj_acc_7, q_proj_acc_7, v_proj_acc_7)
                k0_2, k_proj_acc_3, q_proj_acc_3, v_proj_acc_3, x_chunk_2 = pl.yield_(k0_3, k_proj_acc_5, q_proj_acc_5, v_proj_acc_5, x_chunk_3)
        ...
        for b_0, (attn_out_iter_1, k_cache_iter_1, v_cache_iter_1) in pl.parallel(0, 16, 1, init_values=(attn_out_0, k_cache_0, v_cache_0), chunk=4):
            ...
            with pl.auto_incore():
                for kvh_0, (k_cache_iter_3, v_cache_iter_3) in pl.parallel(0, 8, 1, init_values=(k_cache_iter_1, v_cache_iter_1), chunk=4):
                    ...
                    k_row_0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(pl.tensor.view(k_proj_1, [1, 128], [b_0, kv_col_0]), target_type=pl.FP32, mode=2)
                    ...
                    cache_row_0: pl.Scalar[pl.INDEX] = b_0 * 8 * 4096 + kvh_0 * 4096 + pl.cast(pos_0, pl.INDEX)
                    k_cache_5: pl.Tensor[[524288, 128], pl.BFLOAT16] = pl.tensor.assemble(k_cache_iter_3, pl.tensor.cast(k_rot_2, target_type=pl.BFLOAT16, mode=2), [cache_row_0, 0])
                    v_cache_5: pl.Tensor[[524288, 128], pl.BFLOAT16] = pl.tensor.assemble(v_cache_iter_3, pl.tensor.view(v_proj_1, [1, 128], [b_0, kv_col_0]), [cache_row_0, 0])
            ...
            with pl.auto_incore():
                ...
                for h_0, (attn_row_iter_2, kvh_iter_1) in pl.parallel(0, 64, 1, init_values=(attn_row_1, kvh_0), chunk=8):
                    ...
                    q_row_0: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.cast(pl.tensor.view(q_proj_1, [1, 128], [b_0, q_col_0]), target_type=pl.FP32, mode=2)
                    ...
                    for sb_0, (li_iter_2, mi_iter_2, oi_iter_2) in pl.range(0, ctx_blocks_0, 1, init_values=(li_1, mi_1, oi_1)):
                        ...
                        k_tile_0: pl.Tensor[[64, 128], pl.BFLOAT16] = pl.tensor.view(k_cache_4, [64, 128], [cache_row0_0, 0])
                        v_tile_0: pl.Tensor[[64, 128], pl.BFLOAT16] = pl.tensor.view(v_cache_4, [64, 128], [cache_row0_0, 0])
                        scores_0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.mul(pl.tensor.matmul(q_rot_bf16_0, k_tile_0, a_trans=False, b_trans=True, c_matrix_nz=False), 0.0883883)
        ...
        with pl.auto_incore():
            for ob_1, (k0_iter_4, kb_iter_2, resid1_iter_1) in pl.parallel(0, 80, 1, init_values=(k0_2, kb_1, resid1_0), chunk=8):
                o0_0: pl.Scalar[pl.INDEX] = ob_1 * 64
                ...
                for kb_4, (k0_iter_6, o_acc_iter_2) in pl.range(0, 40, 1, init_values=(k0_iter_4, o_acc_1)):
                    k0_8: pl.Scalar[pl.INDEX] = kb_4 * 128
                    a_chunk_0: pl.Tensor[[16, 128], pl.BFLOAT16] = pl.tensor.cast(pl.tensor.view(attn_out_2, [16, 128], [0, k0_8]), target_type=pl.BFLOAT16, mode=2)
                    w_chunk_0: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.view(wo_0, [128, 64], [k0_8, o0_0])
                    o_acc_4: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.add(o_acc_iter_2, pl.tensor.matmul(a_chunk_0, w_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False))
                    k0_7, o_acc_3 = pl.yield_(k0_8, o_acc_4)
                resid_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.cast(pl.tensor.view(hidden_states_0, [16, 64], [0, o0_0]), target_type=pl.FP32, mode=2)
                resid1_3: pl.Tensor[[16, 5120], pl.FP32] = pl.tensor.assemble(resid1_iter_1, pl.tensor.add(o_acc_3, resid_0), [0, o0_0])
                k0_5, kb_3, resid1_2 = pl.yield_(k0_7, kb_4, resid1_3)
            ...
            for kb_5, (k0_iter_9, sq_sum_iter_7, x_chunk_iter_4) in pl.parallel(0, 40, 1, init_values=(k0_5, sq_sum_6, x_chunk_2), chunk=4):
                k0_11: pl.Scalar[pl.INDEX] = kb_5 * 128
                x_chunk_6: pl.Tensor[[16, 128], pl.FP32] = pl.tensor.view(resid1_2, [16, 128], [0, k0_11])
                sq_sum_9: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.add(sq_sum_iter_7, pl.tensor.row_sum(pl.tensor.mul(x_chunk_6, x_chunk_6)))
                k0_10, sq_sum_8, x_chunk_5 = pl.yield_(k0_11, sq_sum_9, x_chunk_6)
            inv_rms_1: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.rsqrt(pl.tensor.add(pl.tensor.mul(sq_sum_8, 0.000195313), 1e-06))
            ...
            for kb_6, (gamma_iter_1, k0_iter_12, normed_iter_1, normed_bf16_iter_1, post_norm_iter_1, x_chunk_iter_7) in pl.range(0, 40, 1, init_values=(gamma_0, k0_10, normed_0, normed_bf16_0, post_norm_0, x_chunk_5)):
                k0_14: pl.Scalar[pl.INDEX] = kb_6 * 128
                x_chunk_9: pl.Tensor[[16, 128], pl.FP32] = pl.tensor.view(resid1_2, [16, 128], [0, k0_14])
                gamma_3: pl.Tensor[[1, 128], pl.FP32] = pl.tensor.view(post_rms_weight_0, [1, 128], [0, k0_14])
                normed_3: pl.Tensor[[16, 128], pl.FP32] = pl.tensor.col_expand_mul(pl.tensor.row_expand_mul(x_chunk_9, inv_rms_1), gamma_3)
            ...
            for ob_2, (down_proj_acc_iter_2, k0_iter_15, kb_iter_7, o0_iter_1) in pl.range(0, 400, 1, init_values=(down_proj_acc_1, k0_13, kb_6, o0_0)):
                ...
                for kb_9, (gate_acc_iter_2, k0_iter_17, up_acc_iter_2) in pl.range(0, 40, 1, init_values=(gate_acc_1, k0_iter_15, up_acc_1)):
                    ...
                    gate_acc_4: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.add(gate_acc_iter_2, pl.tensor.matmul(post_chunk_0, wg_0, a_trans=False, b_trans=False, c_matrix_nz=False))
                    up_acc_4: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.add(up_acc_iter_2, pl.tensor.matmul(post_chunk_0, wu_0, a_trans=False, b_trans=False, c_matrix_nz=False))
                    gate_acc_3, k0_18, up_acc_3 = pl.yield_(gate_acc_4, k0_19, up_acc_4)
                sigmoid_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.recip(pl.tensor.add(pl.tensor.exp(pl.tensor.neg(gate_acc_3)), 1.0))
                mlp_chunk_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.mul(pl.tensor.mul(gate_acc_3, sigmoid_0), up_acc_3)
                mlp_chunk_bf16_0: pl.Tensor[[16, 64], pl.BFLOAT16] = pl.tensor.cast(mlp_chunk_0, target_type=pl.BFLOAT16, mode=2)
                for dob_0, (down_proj_acc_iter_4,) in pl.parallel(0, 80, 1, init_values=(down_proj_acc_iter_2,), chunk=8):
                    d0_0: pl.Scalar[pl.INDEX] = dob_0 * 64
                    down_prev_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.view(down_proj_acc_iter_4, [16, 64], [0, d0_0])
                    w_down_chunk_0: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.tensor.view(w_down_0, [64, 64], [o0_3, d0_0])
                    down_next_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.add(down_prev_0, pl.tensor.matmul(mlp_chunk_bf16_0, w_down_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False))
                    down_proj_acc_6: pl.Tensor[[16, 5120], pl.FP32] = pl.tensor.assemble(down_proj_acc_iter_4, down_next_0, [0, d0_0])
                    down_proj_acc_5: pl.Tensor[[16, 5120], pl.FP32] = pl.yield_(down_proj_acc_6)
                down_proj_acc_3, k0_16, kb_8, o0_2 = pl.yield_(down_proj_acc_5, k0_18, kb_9, o0_3)
            for ob_3, (o0_iter_4, out_iter_1) in pl.parallel(0, 80, 1, init_values=(o0_2, out_0), chunk=8):
                o0_6: pl.Scalar[pl.INDEX] = ob_3 * 64
                down_acc_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.add(pl.tensor.view(down_proj_acc_3, [16, 64], [0, o0_6]), pl.tensor.view(resid1_2, [16, 64], [0, o0_6]))
                out_3: pl.Tensor[[16, 5120], pl.BFLOAT16] = pl.tensor.assemble(out_iter_1, pl.tensor.cast(down_acc_0, target_type=pl.BFLOAT16, mode=2), [0, o0_6])
                o0_5, out_2 = pl.yield_(o0_6, out_3)
        return out_2