    ...
    def qwen3_decode_layer(self, hidden_states_0: pl.Tensor[[16, 5120], pl.BFLOAT16], cache_pos_0: pl.Tensor[[16], pl.INT32], rope_cos_0: pl.Tensor[[4096, 128], pl.FP32], rope_sin_0: pl.Tensor[[4096, 128], pl.FP32], k_cache_0: pl.Tensor[[524288, 128], pl.BFLOAT16], v_cache_0: pl.Tensor[[524288, 128], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 5120], pl.FP32], wq_0: pl.Tensor[[5120, 5120], pl.BFLOAT16], wk_0: pl.Tensor[[5120, 1024], pl.BFLOAT16], wv_0: pl.Tensor[[5120, 1024], pl.BFLOAT16], wo_0: pl.Tensor[[5120, 5120], pl.BFLOAT16], post_rms_weight_0: pl.Tensor[[1, 5120], pl.FP32], w_gate_0: pl.Tensor[[5120, 25600], pl.BFLOAT16], w_up_0: pl.Tensor[[5120, 25600], pl.BFLOAT16], w_down_0: pl.Tensor[[25600, 5120], pl.BFLOAT16], out_0: pl.Tensor[[16, 5120], pl.BFLOAT16]) -> pl.Tensor[[16, 5120], pl.BFLOAT16]:
        ...
        for b_0, (attn_out_iter_1, k_cache_iter_1, v_cache_iter_1) in pl.parallel(0, 16, 1, init_values=(attn_out_0, k_cache_0, v_cache_0), chunk=4):
            ...
            with pl.auto_incore():
                for kvh_0, (k_cache_iter_3, v_cache_iter_3) in pl.parallel(0, 8, 1, init_values=(k_cache_iter_1, v_cache_iter_1), chunk=4):
                    ...
                    k_cache_5: pl.Tensor[[524288, 128], pl.BFLOAT16] = pl.tensor.assemble(k_cache_iter_3, _t16, [cache_row_0, 0])
                    _t17: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.tensor.view(v_proj_1, [1, 128], [b_0, kv_col_0])
                    v_cache_5: pl.Tensor[[524288, 128], pl.BFLOAT16] = pl.tensor.assemble(v_cache_iter_3, _t17, [cache_row_0, 0])
        ...
        with pl.auto_incore():
            for ob_1, (k0_iter_4, kb_iter_2, resid1_iter_1) in pl.parallel(0, 80, 1, init_values=(k0_2, kb_1, resid1_0), chunk=8):
                ...
                resid1_3: pl.Tensor[[16, 5120], pl.FP32] = pl.tensor.assemble(resid1_iter_1, _t39, [0, o0_0])
            ...
            for kb_5, (k0_iter_9, sq_sum_iter_7, x_chunk_iter_4) in pl.parallel(0, 40, 1, init_values=(k0_5, sq_sum_6, x_chunk_2), chunk=4):
                ...
                sq_sum_9: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.add(sq_sum_iter_7, _t41)
                k0_10, sq_sum_8, x_chunk_5 = pl.yield_(k0_11, sq_sum_9, x_chunk_6)
            _t42: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.mul(sq_sum_8, 0.000195313)
            ...
            for ob_3, (o0_iter_4, out_iter_1) in pl.parallel(0, 80, 1, init_values=(o0_2, out_0), chunk=8):
                ...
                _t53: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.view(resid1_2, [16, 64], [0, o0_6])
                ...
                out_3: pl.Tensor[[16, 5120], pl.BFLOAT16] = pl.tensor.assemble(out_iter_1, _t54, [0, o0_6])
