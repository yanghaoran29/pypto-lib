...
class Qwen3SingleLayerDecode:
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_decode_layer_incore_1(self, k0_3: pl.Scalar[pl.INDEX], k_proj_acc_1: pl.Tensor[[16, 1024], pl.FP32], k_proj_acc_iter_2: pl.Tensor[[16, 1024], pl.FP32], k_proj_acc_iter_4_outer_l0: pl.Tensor[[16, 1024], pl.FP32], normed_bf16_0: pl.Tensor[[16, 128], pl.BFLOAT16], ob_0_out: pl.Scalar[pl.INDEX], q_proj_acc_1: pl.Tensor[[16, 5120], pl.FP32], q_proj_acc_iter_2: pl.Tensor[[16, 5120], pl.FP32], q_proj_acc_iter_4_outer_l0: pl.Tensor[[16, 5120], pl.FP32], v_proj_acc_1: pl.Tensor[[16, 1024], pl.FP32], v_proj_acc_iter_2: pl.Tensor[[16, 1024], pl.FP32], v_proj_acc_iter_4_outer_l0: pl.Tensor[[16, 1024], pl.FP32], wk_0: pl.Tensor[[5120, 1024], pl.BFLOAT16], wq_0: pl.Tensor[[5120, 5120], pl.BFLOAT16], wv_0: pl.Tensor[[5120, 1024], pl.BFLOAT16]) -> tuple[pl.Tensor[[16, 1024], pl.FP32], pl.Tensor[[16, 5120], pl.FP32], pl.Tensor[[16, 1024], pl.FP32]]:
        for ob_0_in, (k_proj_acc_iter_4_outer_l1, q_proj_acc_iter_4_outer_l1, v_proj_acc_iter_4_outer_l1) in pl.parallel(0, 8, 1, init_values=(k_proj_acc_iter_4_outer_l0, q_proj_acc_iter_4_outer_l0, v_proj_acc_iter_4_outer_l0)):
            if 0 + (ob_0_out * 8 + ob_0_in) * 1 < 80:
                ...
                q_prev_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.view(q_proj_acc_iter_4_outer_l1, [16, 64], [0, q0_0])
                ...
                q_proj_acc_6: pl.Tensor[[16, 5120], pl.FP32] = pl.tensor.assemble(q_proj_acc_iter_4_outer_l1, q_next_0, [0, q0_0])
            ...
            if 0 + (ob_0_out * 8 + ob_0_in) * 1 < 16:
                ...
                k_prev_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.view(k_proj_acc_iter_4_outer_l1, [16, 64], [0, kv0_0])
                v_prev_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.view(v_proj_acc_iter_4_outer_l1, [16, 64], [0, kv0_0])
                ...
                k_proj_acc_6: pl.Tensor[[16, 1024], pl.FP32] = pl.tensor.assemble(k_proj_acc_iter_4_outer_l1, k_next_0, [0, kv0_0])
                v_proj_acc_6: pl.Tensor[[16, 1024], pl.FP32] = pl.tensor.assemble(v_proj_acc_iter_4_outer_l1, v_next_0, [0, kv0_0])
    ...
    def qwen3_decode_layer_incore_3(self, attn_row_1: pl.Tensor[[1, 5120], pl.FP32], attn_row_iter_2_outer_l0: pl.Tensor[[1, 5120], pl.FP32], b_0: pl.Scalar[pl.INDEX], cos_hi_0: pl.Tensor[[1, 128 // 2], pl.FP32], cos_lo_0: pl.Tensor[[1, 128 // 2], pl.FP32], ctx_blocks_0: pl.Scalar[pl.INDEX], ctx_len_0: pl.Scalar[pl.INDEX], h_0_out: pl.Scalar[pl.INDEX], k_cache_iter_3_outer_l0_rv: pl.Tensor[[524288, 128], pl.BFLOAT16], kvh_0: pl.Scalar[pl.INDEX], kvh_iter_1_outer_l0: pl.Scalar[pl.INDEX], q_proj_1: pl.Tensor[[16, 5120], pl.BFLOAT16], sin_hi_0: pl.Tensor[[1, 128 // 2], pl.FP32], sin_lo_0: pl.Tensor[[1, 128 // 2], pl.FP32], v_cache_iter_3_outer_l0_rv: pl.Tensor[[524288, 128], pl.BFLOAT16]) -> tuple[pl.Tensor[[1, 5120], pl.FP32], pl.Scalar[pl.INDEX]]:
        for h_0_in, (attn_row_iter_2_outer_l1, kvh_iter_1_outer_l1) in pl.parallel(0, 8, 1, init_values=(attn_row_iter_2_outer_l0, kvh_iter_1_outer_l0)):
            ...
            for sb_0, (li_iter_2, mi_iter_2, oi_iter_2) in pl.range(0, ctx_blocks_0, 1, init_values=(li_1, mi_1, oi_1)):
                ...
                k_tile_0: pl.Tensor[[64, 128], pl.BFLOAT16] = pl.tensor.view(k_cache_iter_3_outer_l0_rv, [64, 128], [cache_row0_0, 0])
                v_tile_0: pl.Tensor[[64, 128], pl.BFLOAT16] = pl.tensor.view(v_cache_iter_3_outer_l0_rv, [64, 128], [cache_row0_0, 0])
    ...
    def qwen3_decode_layer_incore_4(self, attn_out_2: pl.Tensor[[16, 5120], pl.FP32], hidden_states_0: pl.Tensor[[16, 5120], pl.BFLOAT16], k0_2: pl.Scalar[pl.INDEX], k0_iter_4_outer_l0: pl.Scalar[pl.INDEX], kb_1: pl.Scalar[pl.INDEX], kb_iter_2_outer_l0: pl.Scalar[pl.INDEX], ob_1_out: pl.Scalar[pl.INDEX], resid1_0: pl.Tensor[[16, 5120], pl.FP32], resid1_iter_1_outer_l0: pl.Tensor[[16, 5120], pl.FP32], wo_0: pl.Tensor[[5120, 5120], pl.BFLOAT16]) -> tuple[pl.Scalar[pl.INDEX], pl.Scalar[pl.INDEX], pl.Tensor[[16, 5120], pl.FP32]]:
        for ob_1_in, (k0_iter_4_outer_l1, kb_iter_2_outer_l1, resid1_iter_1_outer_l1) in pl.parallel(0, 8, 1, init_values=(k0_iter_4_outer_l0, kb_iter_2_outer_l0, resid1_iter_1_outer_l0)):
            ...
            resid1_3: pl.Tensor[[16, 5120], pl.FP32] = pl.tensor.assemble(resid1_iter_1_outer_l1, _t39, [0, o0_0])
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_decode_layer_incore_6(self, dob_0_out: pl.Scalar[pl.INDEX], down_proj_acc_1: pl.Tensor[[16, 5120], pl.FP32], down_proj_acc_iter_2: pl.Tensor[[16, 5120], pl.FP32], down_proj_acc_iter_4_outer_l0: pl.Tensor[[16, 5120], pl.FP32], mlp_chunk_bf16_0: pl.Tensor[[16, 64], pl.BFLOAT16], o0_3: pl.Scalar[pl.INDEX], w_down_0: pl.Tensor[[25600, 5120], pl.BFLOAT16]) -> pl.Tensor[[16, 5120], pl.FP32]:
        for dob_0_in, (down_proj_acc_iter_4_outer_l1,) in pl.parallel(0, 8, 1, init_values=(down_proj_acc_iter_4_outer_l0,)):
            ...
            down_prev_0: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.view(down_proj_acc_iter_4_outer_l1, [16, 64], [0, d0_0])
            ...
            down_proj_acc_6: pl.Tensor[[16, 5120], pl.FP32] = pl.tensor.assemble(down_proj_acc_iter_4_outer_l1, down_next_0, [0, d0_0])
    ...
    def qwen3_decode_layer(self, hidden_states_0: pl.Tensor[[16, 5120], pl.BFLOAT16], cache_pos_0: pl.Tensor[[16], pl.INT32], rope_cos_0: pl.Tensor[[4096, 128], pl.FP32], rope_sin_0: pl.Tensor[[4096, 128], pl.FP32], k_cache_0: pl.Tensor[[524288, 128], pl.BFLOAT16], v_cache_0: pl.Tensor[[524288, 128], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 5120], pl.FP32], wq_0: pl.Tensor[[5120, 5120], pl.BFLOAT16], wk_0: pl.Tensor[[5120, 1024], pl.BFLOAT16], wv_0: pl.Tensor[[5120, 1024], pl.BFLOAT16], wo_0: pl.Tensor[[5120, 5120], pl.BFLOAT16], post_rms_weight_0: pl.Tensor[[1, 5120], pl.FP32], w_gate_0: pl.Tensor[[5120, 25600], pl.BFLOAT16], w_up_0: pl.Tensor[[5120, 25600], pl.BFLOAT16], w_down_0: pl.Tensor[[25600, 5120], pl.BFLOAT16], out_0: pl.Tensor[[16, 5120], pl.BFLOAT16]) -> pl.Tensor[[16, 5120], pl.BFLOAT16]:
        ...
        for kb_1, (k0_iter_1, k_proj_acc_iter_2, q_proj_acc_iter_2, v_proj_acc_iter_2, x_chunk_iter_1) in pl.range(0, 40, 1, init_values=(k0_0, k_proj_acc_1, q_proj_acc_1, v_proj_acc_1, x_chunk_0)):
            ...
            for ob_0_out, (k_proj_acc_iter_4_outer_l0, q_proj_acc_iter_4_outer_l0, v_proj_acc_iter_4_outer_l0) in pl.range(0, 10, 1, init_values=(k_proj_acc_iter_2, q_proj_acc_iter_2, v_proj_acc_iter_2)):
                ret: pl.Tuple([pl.Tensor[[16, 1024], pl.FP32], pl.Tensor[[16, 5120], pl.FP32], pl.Tensor[[16, 1024], pl.FP32]]) = self.qwen3_decode_layer_incore_1(k0_3, k_proj_acc_1, k_proj_acc_iter_2, k_proj_acc_iter_4_outer_l0, normed_bf16_0, ob_0_out, q_proj_acc_1, q_proj_acc_iter_2, q_proj_acc_iter_4_outer_l0, v_proj_acc_1, v_proj_acc_iter_2, v_proj_acc_iter_4_outer_l0, wk_0, wq_0, wv_0)
        ...
        for b_0, (attn_out_iter_1, k_cache_iter_1, v_cache_iter_1) in pl.parallel(0, 16, 1, init_values=(attn_out_0, k_cache_0, v_cache_0), chunk=4):
            ...
            for h_0_out, (attn_row_iter_2_outer_l0, kvh_iter_1_outer_l0) in pl.range(0, 8, 1, init_values=(attn_row_1, kvh_0)):
                ret: pl.Tuple([pl.Tensor[[1, 5120], pl.FP32], pl.Scalar[pl.INDEX]]) = self.qwen3_decode_layer_incore_3(attn_row_1, attn_row_iter_2_outer_l0, b_0, cos_hi_0, cos_lo_0, ctx_blocks_0, ctx_len_0, h_0_out, k_cache_iter_3_outer_l0_rv, kvh_0, kvh_iter_1_outer_l0, q_proj_1, sin_hi_0, sin_lo_0, v_cache_iter_3_outer_l0_rv)
        ...
        for ob_1_out, (k0_iter_4_outer_l0, kb_iter_2_outer_l0, resid1_iter_1_outer_l0) in pl.range(0, 10, 1, init_values=(k0_2, kb_1, resid1_0)):
            ret: pl.Tuple([pl.Scalar[pl.INDEX], pl.Scalar[pl.INDEX], pl.Tensor[[16, 5120], pl.FP32]]) = self.qwen3_decode_layer_incore_4(attn_out_2, hidden_states_0, k0_2, k0_iter_4_outer_l0, kb_1, kb_iter_2_outer_l0, ob_1_out, resid1_0, resid1_iter_1_outer_l0, wo_0)
        ...
        for ob_2, (down_proj_acc_iter_2, k0_iter_15, kb_iter_7, o0_iter_1) in pl.range(0, 400, 1, init_values=(down_proj_acc_1, k0_13, kb_6, o0_0)):
            ...
            for dob_0_out, (down_proj_acc_iter_4_outer_l0,) in pl.range(0, 10, 1, init_values=(down_proj_acc_iter_2,)):
                down_proj_acc_iter_4_outer_l1_rv: pl.Tensor[[16, 5120], pl.FP32] = self.qwen3_decode_layer_incore_6(dob_0_out, down_proj_acc_1, down_proj_acc_iter_2, down_proj_acc_iter_4_outer_l0, mlp_chunk_bf16_0, o0_3, w_down_0)
