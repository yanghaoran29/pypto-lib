...
class Qwen3SingleLayerDecode:
    ...
    def qwen3_decode_layer_incore_0(self, hidden_states_0: pl.Tensor[[16, 5120], pl.BFLOAT16], kb_0_out: pl.Scalar[pl.INDEX], sq_sum_1: pl.Tensor[[16, 1], pl.FP32], sq_sum_iter_2_outer_l0: pl.Tensor[[16, 1], pl.FP32]) -> pl.Tensor[[16, 1], pl.FP32]:
        for kb_0_in, (sq_sum_iter_2_outer_l1,) in pl.parallel(0, 4, 1, init_values=(sq_sum_iter_2_outer_l0,)):
            ...
            sq_sum_4: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.add(sq_sum_iter_2_outer_l1, _t2)
            sq_sum_iter_2_outer_l1_rv: pl.Tensor[[16, 1], pl.FP32] = pl.yield_(sq_sum_4)
        return sq_sum_iter_2_outer_l1_rv
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_decode_layer_incore_2(self, b_0: pl.Scalar[pl.INDEX], cos_hi_0: pl.Tensor[[1, 128 // 2], pl.FP32], cos_lo_0: pl.Tensor[[1, 128 // 2], pl.FP32], k_cache_0: pl.Tensor[[524288, 128], pl.BFLOAT16], k_cache_iter_1: pl.Tensor[[524288, 128], pl.BFLOAT16], k_cache_iter_3_outer_l0: pl.Tensor[[524288, 128], pl.BFLOAT16], k_proj_1: pl.Tensor[[16, 1024], pl.BFLOAT16], kvh_0_out: pl.Scalar[pl.INDEX], pos_0: pl.Scalar[pl.INT32], sin_hi_0: pl.Tensor[[1, 128 // 2], pl.FP32], sin_lo_0: pl.Tensor[[1, 128 // 2], pl.FP32], v_cache_0: pl.Tensor[[524288, 128], pl.BFLOAT16], v_cache_iter_1: pl.Tensor[[524288, 128], pl.BFLOAT16], v_cache_iter_3_outer_l0: pl.Tensor[[524288, 128], pl.BFLOAT16], v_proj_1: pl.Tensor[[16, 1024], pl.BFLOAT16]) -> tuple[pl.Tensor[[524288, 128], pl.BFLOAT16], pl.Tensor[[524288, 128], pl.BFLOAT16]]:
        for kvh_0_in, (k_cache_iter_3_outer_l1, v_cache_iter_3_outer_l1) in pl.parallel(0, 4, 1, init_values=(k_cache_iter_3_outer_l0, v_cache_iter_3_outer_l0)):
            ...
            k_cache_5: pl.Tensor[[524288, 128], pl.BFLOAT16] = pl.tensor.assemble(k_cache_iter_3_outer_l1, _t16, [cache_row_0, 0])
            _t17: pl.Tensor[[1, 128], pl.BFLOAT16] = pl.tensor.view(v_proj_1, [1, 128], [b_0, kv_col_0])
            v_cache_5: pl.Tensor[[524288, 128], pl.BFLOAT16] = pl.tensor.assemble(v_cache_iter_3_outer_l1, _t17, [cache_row_0, 0])
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_decode_layer_incore_5(self, k0_5: pl.Scalar[pl.INDEX], k0_iter_9_outer_l0: pl.Scalar[pl.INDEX], kb_5_out: pl.Scalar[pl.INDEX], resid1_iter_1_outer_l0_rv: pl.Tensor[[16, 5120], pl.FP32], sq_sum_6: pl.Tensor[[16, 1], pl.FP32], sq_sum_iter_7_outer_l0: pl.Tensor[[16, 1], pl.FP32], x_chunk_2: pl.Tensor[[16, 128], pl.FP32], x_chunk_iter_4_outer_l0: pl.Tensor[[16, 128], pl.FP32]) -> tuple[pl.Scalar[pl.INDEX], pl.Tensor[[16, 1], pl.FP32], pl.Tensor[[16, 128], pl.FP32]]:
        for kb_5_in, (k0_iter_9_outer_l1, sq_sum_iter_7_outer_l1, x_chunk_iter_4_outer_l1) in pl.parallel(0, 4, 1, init_values=(k0_iter_9_outer_l0, sq_sum_iter_7_outer_l0, x_chunk_iter_4_outer_l0)):
            ...
            x_chunk_6: pl.Tensor[[16, 128], pl.FP32] = pl.tensor.view(resid1_iter_1_outer_l0_rv, [16, 128], [0, k0_11])
            _t40: pl.Tensor[[16, 128], pl.FP32] = pl.tensor.mul(x_chunk_6, x_chunk_6)
            _t41: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.row_sum(_t40)
            sq_sum_9: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.add(sq_sum_iter_7_outer_l1, _t41)
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_decode_layer_incore_7(self, down_proj_acc_3: pl.Tensor[[16, 5120], pl.FP32], o0_2: pl.Scalar[pl.INDEX], o0_iter_4_outer_l0: pl.Scalar[pl.INDEX], ob_3_out: pl.Scalar[pl.INDEX], out_0: pl.Tensor[[16, 5120], pl.BFLOAT16], out_iter_1_outer_l0: pl.Tensor[[16, 5120], pl.BFLOAT16], resid1_iter_1_outer_l0_rv: pl.Tensor[[16, 5120], pl.FP32]) -> tuple[pl.Scalar[pl.INDEX], pl.Tensor[[16, 5120], pl.BFLOAT16]]:
        for ob_3_in, (o0_iter_4_outer_l1, out_iter_1_outer_l1) in pl.parallel(0, 8, 1, init_values=(o0_iter_4_outer_l0, out_iter_1_outer_l0)):
            ...
            _t53: pl.Tensor[[16, 64], pl.FP32] = pl.tensor.view(resid1_iter_1_outer_l0_rv, [16, 64], [0, o0_6])
            ...
            out_3: pl.Tensor[[16, 5120], pl.BFLOAT16] = pl.tensor.assemble(out_iter_1_outer_l1, _t54, [0, o0_6])
    ...
    def qwen3_decode_layer(self, hidden_states_0: pl.Tensor[[16, 5120], pl.BFLOAT16], cache_pos_0: pl.Tensor[[16], pl.INT32], rope_cos_0: pl.Tensor[[4096, 128], pl.FP32], rope_sin_0: pl.Tensor[[4096, 128], pl.FP32], k_cache_0: pl.Tensor[[524288, 128], pl.BFLOAT16], v_cache_0: pl.Tensor[[524288, 128], pl.BFLOAT16], input_rms_weight_0: pl.Tensor[[1, 5120], pl.FP32], wq_0: pl.Tensor[[5120, 5120], pl.BFLOAT16], wk_0: pl.Tensor[[5120, 1024], pl.BFLOAT16], wv_0: pl.Tensor[[5120, 1024], pl.BFLOAT16], wo_0: pl.Tensor[[5120, 5120], pl.BFLOAT16], post_rms_weight_0: pl.Tensor[[1, 5120], pl.FP32], w_gate_0: pl.Tensor[[5120, 25600], pl.BFLOAT16], w_up_0: pl.Tensor[[5120, 25600], pl.BFLOAT16], w_down_0: pl.Tensor[[25600, 5120], pl.BFLOAT16], out_0: pl.Tensor[[16, 5120], pl.BFLOAT16]) -> pl.Tensor[[16, 5120], pl.BFLOAT16]:
        ...
        for kb_0_out, (sq_sum_iter_2_outer_l0,) in pl.range(0, 10, 1, init_values=(sq_sum_1,)):
            sq_sum_iter_2_outer_l1_rv: pl.Tensor[[16, 1], pl.FP32] = self.qwen3_decode_layer_incore_0(hidden_states_0, kb_0_out, sq_sum_1, sq_sum_iter_2_outer_l0)
            sq_sum_iter_2_outer_l0_rv: pl.Tensor[[16, 1], pl.FP32] = pl.yield_(sq_sum_iter_2_outer_l1_rv)
        _t3: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.mul(sq_sum_iter_2_outer_l0_rv, 0.000195313)
        ...
        for kb_1, (k0_iter_1, k_proj_acc_iter_2, q_proj_acc_iter_2, v_proj_acc_iter_2, x_chunk_iter_1) in pl.range(0, 40, 1, init_values=(k0_0, k_proj_acc_1, q_proj_acc_1, v_proj_acc_1, x_chunk_0)):
            ...
            for ob_0_out, (k_proj_acc_iter_4_outer_l0, q_proj_acc_iter_4_outer_l0, v_proj_acc_iter_4_outer_l0) in pl.range(0, 10, 1, init_values=(k_proj_acc_iter_2, q_proj_acc_iter_2, v_proj_acc_iter_2)):
                ...
                k_proj_acc_iter_4_outer_l1_rv: pl.Tensor[[16, 1024], pl.FP32] = ret[0]
                q_proj_acc_iter_4_outer_l1_rv: pl.Tensor[[16, 5120], pl.FP32] = ret[1]
                v_proj_acc_iter_4_outer_l1_rv: pl.Tensor[[16, 1024], pl.FP32] = ret[2]
        ...
        for b_0, (attn_out_iter_1, k_cache_iter_1, v_cache_iter_1) in pl.parallel(0, 16, 1, init_values=(attn_out_0, k_cache_0, v_cache_0), chunk=4):
            ...
            for kvh_0_out, (k_cache_iter_3_outer_l0, v_cache_iter_3_outer_l0) in pl.range(0, 2, 1, init_values=(k_cache_iter_1, v_cache_iter_1)):
                ...
                k_cache_iter_3_outer_l1_rv: pl.Tensor[[524288, 128], pl.BFLOAT16] = ret[0]
                v_cache_iter_3_outer_l1_rv: pl.Tensor[[524288, 128], pl.BFLOAT16] = ret[1]
        ...
        for ob_1_out, (k0_iter_4_outer_l0, kb_iter_2_outer_l0, resid1_iter_1_outer_l0) in pl.range(0, 10, 1, init_values=(k0_2, kb_1, resid1_0)):
            ...
            resid1_iter_1_outer_l1_rv: pl.Tensor[[16, 5120], pl.FP32] = ret[2]
        ...
        for kb_5_out, (k0_iter_9_outer_l0, sq_sum_iter_7_outer_l0, x_chunk_iter_4_outer_l0) in pl.range(0, 10, 1, init_values=(k0_5, sq_sum_6, x_chunk_2)):
            ...
            sq_sum_iter_7_outer_l1_rv: pl.Tensor[[16, 1], pl.FP32] = ret[1]
            x_chunk_iter_4_outer_l1_rv: pl.Tensor[[16, 128], pl.FP32] = ret[2]
        ...
        _t42: pl.Tensor[[16, 1], pl.FP32] = pl.tensor.mul(sq_sum_iter_7_outer_l0_rv, 0.000195313)
        ...
        for kb_6, (gamma_iter_1, k0_iter_12, normed_iter_1, normed_bf16_iter_1, post_norm_iter_1, x_chunk_iter_7) in pl.range(0, 40, 1, init_values=(gamma_0, k0_iter_9_outer_l0_rv, normed_0, normed_bf16_0, post_norm_0, x_chunk_iter_4_outer_l0_rv)):
            ...
            x_chunk_9: pl.Tensor[[16, 128], pl.FP32] = pl.tensor.view(resid1_iter_1_outer_l0_rv, [16, 128], [0, k0_14])
        ...
        for ob_2, (down_proj_acc_iter_2, k0_iter_15, kb_iter_7, o0_iter_1) in pl.range(0, 400, 1, init_values=(down_proj_acc_1, k0_13, kb_6, o0_0)):
            ...
            for dob_0_out, (down_proj_acc_iter_4_outer_l0,) in pl.range(0, 10, 1, init_values=(down_proj_acc_iter_2,)):
                down_proj_acc_iter_4_outer_l1_rv: pl.Tensor[[16, 5120], pl.FP32] = self.call_group(qwen3_decode_layer_incore_6_group, dob_0_out, down_proj_acc_1, down_proj_acc_iter_2, down_proj_acc_iter_4_outer_l0, mlp_chunk_bf16_0, o0_3, w_down_0)
                down_proj_acc_iter_4_outer_l0_rv: pl.Tensor[[16, 5120], pl.FP32] = pl.yield_(down_proj_acc_iter_4_outer_l1_rv)
        ...
        for ob_3_out, (o0_iter_4_outer_l0, out_iter_1_outer_l0) in pl.range(0, 10, 1, init_values=(o0_2, out_0)):
            ...
            out_iter_1_outer_l1_rv: pl.Tensor[[16, 5120], pl.BFLOAT16] = ret[1]
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_decode_layer_incore_1_aic(self, k0_3: pl.Scalar[pl.INDEX], k_proj_acc_1: pl.Tensor[[16, 1024], pl.FP32], k_proj_acc_iter_2: pl.Tensor[[16, 1024], pl.FP32], k_proj_acc_iter_4_outer_l0: pl.Tensor[[16, 1024], pl.FP32], normed_bf16_0: pl.Tensor[[16, 128], pl.BFLOAT16], ob_0_out: pl.Scalar[pl.INDEX], q_proj_acc_1: pl.Tensor[[16, 5120], pl.FP32], q_proj_acc_iter_2: pl.Tensor[[16, 5120], pl.FP32], q_proj_acc_iter_4_outer_l0: pl.Tensor[[16, 5120], pl.FP32], v_proj_acc_1: pl.Tensor[[16, 1024], pl.FP32], v_proj_acc_iter_2: pl.Tensor[[16, 1024], pl.FP32], v_proj_acc_iter_4_outer_l0: pl.Tensor[[16, 1024], pl.FP32], wk_0: pl.Tensor[[5120, 1024], pl.BFLOAT16], wq_0: pl.Tensor[[5120, 5120], pl.BFLOAT16], wv_0: pl.Tensor[[5120, 1024], pl.BFLOAT16]) -> tuple[pl.Tensor[[16, 1024], pl.FP32], pl.Tensor[[16, 5120], pl.FP32], pl.Tensor[[16, 1024], pl.FP32]]:
        ...
        for ob_0_in, (k_proj_acc_iter_4_outer_l1, q_proj_acc_iter_4_outer_l1, v_proj_acc_iter_4_outer_l1) in pl.parallel(0, 8, 1, init_values=(k_proj_acc_iter_4_outer_l0, q_proj_acc_iter_4_outer_l0, v_proj_acc_iter_4_outer_l0)):
            if 0 + (ob_0_out * 8 + ob_0_in) * 1 < 80:
                ...
                wq_chunk_0__h0: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                wq_chunk_0__h1: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                wq_chunk_0__tmp: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.create(__list__(128, 64), dtype=pl.BFLOAT16)
                wq_chunk_0__mid: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.assemble(wq_chunk_0__tmp, wq_chunk_0__h0, __list__(0, 0))
                pl.comm.tfree_to_aiv(0)
                wq_chunk_0: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.assemble(wq_chunk_0__mid, wq_chunk_0__h1, __list__(64, 0))
                ...
                __half0__: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.tensor.view(_t6, __list__(8, 64), __list__(0, 0))
                __half1__: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.tensor.view(_t6, __list__(8, 64), __list__(8, 0))
                pl.comm.tpush_to_aiv(__half0__, 0)
                pl.comm.tpush_to_aiv(__half1__, 1)
            else:
                q_proj_acc_7: pl.Tensor[[16, 5120], pl.FP32] = pl.yield_(q_proj_acc_iter_4_outer_l1)
            if 0 + (ob_0_out * 8 + ob_0_in) * 1 < 16:
                kv0_0: pl.Scalar[pl.INDEX] = (0 + (ob_0_out * 8 + ob_0_in) * 1) * 64
                wk_chunk_0__h0: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                wk_chunk_0__h1: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                wk_chunk_0__tmp: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.create(__list__(128, 64), dtype=pl.BFLOAT16)
                wk_chunk_0__mid: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.assemble(wk_chunk_0__tmp, wk_chunk_0__h0, __list__(0, 0))
                pl.comm.tfree_to_aiv(0)
                wk_chunk_0: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.assemble(wk_chunk_0__mid, wk_chunk_0__h1, __list__(64, 0))
                pl.comm.tfree_to_aiv(1)
                wv_chunk_0__h0: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                wv_chunk_0__h1: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                wv_chunk_0__tmp: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.create(__list__(128, 64), dtype=pl.BFLOAT16)
                wv_chunk_0__mid: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.assemble(wv_chunk_0__tmp, wv_chunk_0__h0, __list__(0, 0))
                pl.comm.tfree_to_aiv(0)
                wv_chunk_0: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.assemble(wv_chunk_0__mid, wv_chunk_0__h1, __list__(64, 0))
                pl.comm.tfree_to_aiv(1)
                _t7: pl.Tensor[[16, 64], pl.BFLOAT16] = pl.tensor.matmul(normed_bf16_0, wk_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False)
                __half0__: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.tensor.view(_t7, __list__(8, 64), __list__(0, 0))
                __half1__: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.tensor.view(_t7, __list__(8, 64), __list__(8, 0))
                pl.comm.tpush_to_aiv(__half0__, 0)
                pl.comm.tpush_to_aiv(__half1__, 1)
                _t8: pl.Tensor[[16, 64], pl.BFLOAT16] = pl.tensor.matmul(normed_bf16_0, wv_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False)
                __half0__: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.tensor.view(_t8, __list__(8, 64), __list__(0, 0))
                __half1__: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.tensor.view(_t8, __list__(8, 64), __list__(8, 0))
                pl.comm.tpush_to_aiv(__half0__, 0)
                pl.comm.tpush_to_aiv(__half1__, 1)
            else:
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_decode_layer_incore_1_aiv(self, k0_3: pl.Scalar[pl.INDEX], k_proj_acc_1: pl.Tensor[[16, 1024], pl.FP32], k_proj_acc_iter_2: pl.Tensor[[16, 1024], pl.FP32], k_proj_acc_iter_4_outer_l0: pl.Tensor[[16, 1024], pl.FP32], normed_bf16_0: pl.Tensor[[16, 128], pl.BFLOAT16], ob_0_out: pl.Scalar[pl.INDEX], q_proj_acc_1: pl.Tensor[[16, 5120], pl.FP32], q_proj_acc_iter_2: pl.Tensor[[16, 5120], pl.FP32], q_proj_acc_iter_4_outer_l0: pl.Tensor[[16, 5120], pl.FP32], v_proj_acc_1: pl.Tensor[[16, 1024], pl.FP32], v_proj_acc_iter_2: pl.Tensor[[16, 1024], pl.FP32], v_proj_acc_iter_4_outer_l0: pl.Tensor[[16, 1024], pl.FP32], wk_0: pl.Tensor[[5120, 1024], pl.BFLOAT16], wq_0: pl.Tensor[[5120, 5120], pl.BFLOAT16], wv_0: pl.Tensor[[5120, 1024], pl.BFLOAT16], AIV_IDX: pl.Scalar[pl.INDEX]) -> tuple[pl.Tensor[[16, 1024], pl.FP32], pl.Tensor[[16, 5120], pl.FP32], pl.Tensor[[16, 1024], pl.FP32]]:
        pl.comm.aiv_initialize_pipe()
        for ob_0_in, (k_proj_acc_iter_4_outer_l1, q_proj_acc_iter_4_outer_l1, v_proj_acc_iter_4_outer_l1) in pl.parallel(0, 8, 1, init_values=(k_proj_acc_iter_4_outer_l0, q_proj_acc_iter_4_outer_l0, v_proj_acc_iter_4_outer_l0)):
            if 0 + (ob_0_out * 8 + ob_0_in) * 1 < 80:
                q0_0: pl.Scalar[pl.INDEX] = (0 + (ob_0_out * 8 + ob_0_in) * 1) * 64
                q_prev_0: pl.Tensor[[8, 64], pl.FP32] = pl.tensor.view(q_proj_acc_iter_4_outer_l1, [8, 64], [0, q0_0])
                wq_chunk_0: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.tensor.view(wq_0, [64, 64], [k0_3 + AIV_IDX * 64, q0_0])
                pl.comm.tpush_to_aic(wq_chunk_0, AIV_IDX)
                _t6: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.comm.tpop_from_aic(AIV_IDX)
                q_next_0: pl.Tensor[[8, 64], pl.FP32] = pl.tensor.add(q_prev_0, _t6)
                pl.comm.tfree_to_aic(AIV_IDX)
                q_proj_acc_6: pl.Tensor[[16, 5120], pl.FP32] = pl.tensor.assemble(q_proj_acc_iter_4_outer_l1, q_next_0, [0 + AIV_IDX * 8, q0_0])
                q_proj_acc_7: pl.Tensor[[16, 5120], pl.FP32] = pl.yield_(q_proj_acc_6)
            else:
                q_proj_acc_7: pl.Tensor[[16, 5120], pl.FP32] = pl.yield_(q_proj_acc_iter_4_outer_l1)
            if 0 + (ob_0_out * 8 + ob_0_in) * 1 < 16:
                kv0_0: pl.Scalar[pl.INDEX] = (0 + (ob_0_out * 8 + ob_0_in) * 1) * 64
                k_prev_0: pl.Tensor[[8, 64], pl.FP32] = pl.tensor.view(k_proj_acc_iter_4_outer_l1, [8, 64], [0, kv0_0])
                v_prev_0: pl.Tensor[[8, 64], pl.FP32] = pl.tensor.view(v_proj_acc_iter_4_outer_l1, [8, 64], [0, kv0_0])
                wk_chunk_0: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.tensor.view(wk_0, [64, 64], [k0_3 + AIV_IDX * 64, kv0_0])
                pl.comm.tpush_to_aic(wk_chunk_0, AIV_IDX)
                wv_chunk_0: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.tensor.view(wv_0, [64, 64], [k0_3 + AIV_IDX * 64, kv0_0])
                pl.comm.tpush_to_aic(wv_chunk_0, AIV_IDX)
                _t7: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.comm.tpop_from_aic(AIV_IDX)
                k_next_0: pl.Tensor[[8, 64], pl.FP32] = pl.tensor.add(k_prev_0, _t7)
                pl.comm.tfree_to_aic(AIV_IDX)
                _t8: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.comm.tpop_from_aic(AIV_IDX)
                v_next_0: pl.Tensor[[8, 64], pl.FP32] = pl.tensor.add(v_prev_0, _t8)
                pl.comm.tfree_to_aic(AIV_IDX)
                k_proj_acc_6: pl.Tensor[[16, 1024], pl.FP32] = pl.tensor.assemble(k_proj_acc_iter_4_outer_l1, k_next_0, [0 + AIV_IDX * 8, kv0_0])
                v_proj_acc_6: pl.Tensor[[16, 1024], pl.FP32] = pl.tensor.assemble(v_proj_acc_iter_4_outer_l1, v_next_0, [0 + AIV_IDX * 8, kv0_0])
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_decode_layer_incore_3_aic(self, attn_row_1: pl.Tensor[[1, 5120], pl.FP32], attn_row_iter_2_outer_l0: pl.Tensor[[1, 5120], pl.FP32], b_0: pl.Scalar[pl.INDEX], cos_hi_0: pl.Tensor[[1, 128 // 2], pl.FP32], cos_lo_0: pl.Tensor[[1, 128 // 2], pl.FP32], ctx_blocks_0: pl.Scalar[pl.INDEX], ctx_len_0: pl.Scalar[pl.INDEX], h_0_out: pl.Scalar[pl.INDEX], k_cache_iter_3_outer_l0_rv: pl.Tensor[[524288, 128], pl.BFLOAT16], kvh_0: pl.Scalar[pl.INDEX], kvh_iter_1_outer_l0: pl.Scalar[pl.INDEX], q_proj_1: pl.Tensor[[16, 5120], pl.BFLOAT16], sin_hi_0: pl.Tensor[[1, 128 // 2], pl.FP32], sin_lo_0: pl.Tensor[[1, 128 // 2], pl.FP32], v_cache_iter_3_outer_l0_rv: pl.Tensor[[524288, 128], pl.BFLOAT16]) -> tuple[pl.Tensor[[1, 5120], pl.FP32], pl.Scalar[pl.INDEX]]:
        pl.comm.aic_initialize_pipe()
        for h_0_in, (attn_row_iter_2_outer_l1, kvh_iter_1_outer_l1) in pl.parallel(0, 8, 1, init_values=(attn_row_iter_2_outer_l0, kvh_iter_1_outer_l0)):
            ...
            for sb_0 in pl.range(0, ctx_blocks_0, 1):
                ...
                k_tile_0__h0: pl.Tensor[[32, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                k_tile_0__h1: pl.Tensor[[32, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                k_tile_0__tmp: pl.Tensor[[64, 128], pl.BFLOAT16] = pl.tensor.create(__list__(64, 128), dtype=pl.BFLOAT16)
                k_tile_0__mid: pl.Tensor[[64, 128], pl.BFLOAT16] = pl.tensor.assemble(k_tile_0__tmp, k_tile_0__h0, __list__(0, 0))
                pl.comm.tfree_to_aiv(0)
                k_tile_0: pl.Tensor[[64, 128], pl.BFLOAT16] = pl.tensor.assemble(k_tile_0__mid, k_tile_0__h1, __list__(32, 0))
                pl.comm.tfree_to_aiv(1)
                v_tile_0__h0: pl.Tensor[[32, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                v_tile_0__h1: pl.Tensor[[32, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                v_tile_0__tmp: pl.Tensor[[64, 128], pl.BFLOAT16] = pl.tensor.create(__list__(64, 128), dtype=pl.BFLOAT16)
                v_tile_0__mid: pl.Tensor[[64, 128], pl.BFLOAT16] = pl.tensor.assemble(v_tile_0__tmp, v_tile_0__h0, __list__(0, 0))
                pl.comm.tfree_to_aiv(0)
                v_tile_0: pl.Tensor[[64, 128], pl.BFLOAT16] = pl.tensor.assemble(v_tile_0__mid, v_tile_0__h1, __list__(32, 0))
                pl.comm.tfree_to_aiv(1)
                ...
                _t29: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.comm.tpop_from_aiv()
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_decode_layer_incore_3_aiv(self, attn_row_1: pl.Tensor[[1, 5120], pl.FP32], attn_row_iter_2_outer_l0: pl.Tensor[[1, 5120], pl.FP32], b_0: pl.Scalar[pl.INDEX], cos_hi_0: pl.Tensor[[1, 128 // 2], pl.FP32], cos_lo_0: pl.Tensor[[1, 128 // 2], pl.FP32], ctx_blocks_0: pl.Scalar[pl.INDEX], ctx_len_0: pl.Scalar[pl.INDEX], h_0_out: pl.Scalar[pl.INDEX], k_cache_iter_3_outer_l0_rv: pl.Tensor[[524288, 128], pl.BFLOAT16], kvh_0: pl.Scalar[pl.INDEX], kvh_iter_1_outer_l0: pl.Scalar[pl.INDEX], q_proj_1: pl.Tensor[[16, 5120], pl.BFLOAT16], sin_hi_0: pl.Tensor[[1, 128 // 2], pl.FP32], sin_lo_0: pl.Tensor[[1, 128 // 2], pl.FP32], v_cache_iter_3_outer_l0_rv: pl.Tensor[[524288, 128], pl.BFLOAT16], AIV_IDX: pl.Scalar[pl.INDEX]) -> tuple[pl.Tensor[[1, 5120], pl.FP32], pl.Scalar[pl.INDEX]]:
        pl.comm.aiv_initialize_pipe()
        for h_0_in, (attn_row_iter_2_outer_l1, kvh_iter_1_outer_l1) in pl.parallel(0, 8, 1, init_values=(attn_row_iter_2_outer_l0, kvh_iter_1_outer_l0)):
            kvh_3: pl.Scalar[pl.INDEX] = (0 + (h_0_out * 8 + h_0_in) * 1) // 8
            q_col_0: pl.Scalar[pl.INDEX] = (0 + (h_0_out * 8 + h_0_in) * 1) * 128
            _t18: pl.Tensor[[1, 64], pl.BFLOAT16] = pl.tensor.view(q_proj_1, [1, 64], [b_0, q_col_0 + AIV_IDX * 64])
            q_row_0: pl.Tensor[[1, 64], pl.FP32] = pl.tensor.cast(_t18, target_type=pl.FP32, mode=2)
            ...
            for sb_0, (li_iter_2, mi_iter_2, oi_iter_2) in pl.range(0, ctx_blocks_0, 1, init_values=(li_1, mi_1, oi_1)):
                ...
                valid_len_0: pl.Scalar[pl.INDEX] = min(64, ctx_len_0 - s0_0)
                cache_row0_0: pl.Scalar[pl.INDEX] = b_0 * 8 * 4096 + kvh_3 * 4096 + s0_0
                k_tile_0: pl.Tensor[[32, 128], pl.BFLOAT16] = pl.tensor.view(k_cache_iter_3_outer_l0_rv, [32, 128], [cache_row0_0 + AIV_IDX * 32, 0])
                pl.comm.tpush_to_aic(k_tile_0, AIV_IDX)
                v_tile_0: pl.Tensor[[32, 128], pl.BFLOAT16] = pl.tensor.view(v_cache_iter_3_outer_l0_rv, [32, 128], [cache_row0_0 + AIV_IDX * 32, 0])
                pl.comm.tpush_to_aic(v_tile_0, AIV_IDX)
                exp_pad_0: pl.Tensor[[1, 32], pl.FP32] = pl.tensor.create([1, 32], dtype=pl.FP32)
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_decode_layer_incore_4_aic(self, attn_out_2: pl.Tensor[[16, 5120], pl.FP32], hidden_states_0: pl.Tensor[[16, 5120], pl.BFLOAT16], k0_2: pl.Scalar[pl.INDEX], k0_iter_4_outer_l0: pl.Scalar[pl.INDEX], kb_1: pl.Scalar[pl.INDEX], kb_iter_2_outer_l0: pl.Scalar[pl.INDEX], ob_1_out: pl.Scalar[pl.INDEX], resid1_0: pl.Tensor[[16, 5120], pl.FP32], resid1_iter_1_outer_l0: pl.Tensor[[16, 5120], pl.FP32], wo_0: pl.Tensor[[5120, 5120], pl.BFLOAT16]) -> tuple[pl.Scalar[pl.INDEX], pl.Scalar[pl.INDEX], pl.Tensor[[16, 5120], pl.FP32]]:
        pl.comm.aic_initialize_pipe()
        for ob_1_in, (k0_iter_4_outer_l1, kb_iter_2_outer_l1, resid1_iter_1_outer_l1) in pl.parallel(0, 8, 1, init_values=(k0_iter_4_outer_l0, kb_iter_2_outer_l0, resid1_iter_1_outer_l0)):
            ...
            for kb_4, (k0_iter_6,) in pl.range(0, 40, 1, init_values=(k0_iter_4_outer_l1,)):
                ...
                a_chunk_0__h0: pl.Tensor[[8, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                a_chunk_0__h1: pl.Tensor[[8, 128], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                a_chunk_0__tmp: pl.Tensor[[16, 128], pl.BFLOAT16] = pl.tensor.create(__list__(16, 128), dtype=pl.BFLOAT16)
                a_chunk_0__mid: pl.Tensor[[16, 128], pl.BFLOAT16] = pl.tensor.assemble(a_chunk_0__tmp, a_chunk_0__h0, __list__(0, 0))
                pl.comm.tfree_to_aiv(0)
                a_chunk_0: pl.Tensor[[16, 128], pl.BFLOAT16] = pl.tensor.assemble(a_chunk_0__mid, a_chunk_0__h1, __list__(8, 0))
                pl.comm.tfree_to_aiv(1)
                w_chunk_0__h0: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
                w_chunk_0__h1: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
                w_chunk_0__tmp: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.create(__list__(128, 64), dtype=pl.BFLOAT16)
                w_chunk_0__mid: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.assemble(w_chunk_0__tmp, w_chunk_0__h0, __list__(0, 0))
                pl.comm.tfree_to_aiv(0)
                w_chunk_0: pl.Tensor[[128, 64], pl.BFLOAT16] = pl.tensor.assemble(w_chunk_0__mid, w_chunk_0__h1, __list__(64, 0))
                pl.comm.tfree_to_aiv(1)
                _t37: pl.Tensor[[16, 64], pl.BFLOAT16] = pl.tensor.matmul(a_chunk_0, w_chunk_0, a_trans=False, b_trans=False, c_matrix_nz=False)
                __half0__: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.tensor.view(_t37, __list__(8, 64), __list__(0, 0))
                __half1__: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.tensor.view(_t37, __list__(8, 64), __list__(8, 0))
                pl.comm.tpush_to_aiv(__half0__, 0)
                pl.comm.tpush_to_aiv(__half1__, 1)
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_decode_layer_incore_4_aiv(self, attn_out_2: pl.Tensor[[16, 5120], pl.FP32], hidden_states_0: pl.Tensor[[16, 5120], pl.BFLOAT16], k0_2: pl.Scalar[pl.INDEX], k0_iter_4_outer_l0: pl.Scalar[pl.INDEX], kb_1: pl.Scalar[pl.INDEX], kb_iter_2_outer_l0: pl.Scalar[pl.INDEX], ob_1_out: pl.Scalar[pl.INDEX], resid1_0: pl.Tensor[[16, 5120], pl.FP32], resid1_iter_1_outer_l0: pl.Tensor[[16, 5120], pl.FP32], wo_0: pl.Tensor[[5120, 5120], pl.BFLOAT16], AIV_IDX: pl.Scalar[pl.INDEX]) -> tuple[pl.Scalar[pl.INDEX], pl.Scalar[pl.INDEX], pl.Tensor[[16, 5120], pl.FP32]]:
        pl.comm.aiv_initialize_pipe()
        for ob_1_in, (k0_iter_4_outer_l1, kb_iter_2_outer_l1, resid1_iter_1_outer_l1) in pl.parallel(0, 8, 1, init_values=(k0_iter_4_outer_l0, kb_iter_2_outer_l0, resid1_iter_1_outer_l0)):
            o0_0: pl.Scalar[pl.INDEX] = (0 + (ob_1_out * 8 + ob_1_in) * 1) * 64
            o_acc_0: pl.Tensor[[8, 64], pl.FP32] = pl.tensor.create([8, 64], dtype=pl.FP32)
            ...
            for kb_4, (k0_iter_6, o_acc_iter_2) in pl.range(0, 40, 1, init_values=(k0_iter_4_outer_l1, o_acc_1)):
                k0_8: pl.Scalar[pl.INDEX] = kb_4 * 128
                _t36: pl.Tensor[[8, 128], pl.FP32] = pl.tensor.view(attn_out_2, [8, 128], [0 + AIV_IDX * 8, k0_8])
                a_chunk_0: pl.Tensor[[8, 128], pl.BFLOAT16] = pl.tensor.cast(_t36, target_type=pl.BFLOAT16, mode=2)
                pl.comm.tpush_to_aic(a_chunk_0, AIV_IDX)
                w_chunk_0: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.tensor.view(wo_0, [64, 64], [k0_8 + AIV_IDX * 64, o0_0])
                pl.comm.tpush_to_aic(w_chunk_0, AIV_IDX)
                _t37: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.comm.tpop_from_aic(AIV_IDX)
                o_acc_4: pl.Tensor[[8, 64], pl.FP32] = pl.tensor.add(o_acc_iter_2, _t37)
                pl.comm.tfree_to_aic(AIV_IDX)
                k0_7, o_acc_3 = pl.yield_(k0_8, o_acc_4)
            _t38: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.tensor.view(hidden_states_0, [8, 64], [0 + AIV_IDX * 8, o0_0])
            resid_0: pl.Tensor[[8, 64], pl.FP32] = pl.tensor.cast(_t38, target_type=pl.FP32, mode=2)
            _t39: pl.Tensor[[8, 64], pl.FP32] = pl.tensor.add(o_acc_3, resid_0)
            resid1_3: pl.Tensor[[16, 5120], pl.FP32] = pl.tensor.assemble(resid1_iter_1_outer_l1, _t39, [0 + AIV_IDX * 8, o0_0])
    ...
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_decode_layer_incore_6_aic(self, dob_0_out: pl.Scalar[pl.INDEX], down_proj_acc_1: pl.Tensor[[16, 5120], pl.FP32], down_proj_acc_iter_2: pl.Tensor[[16, 5120], pl.FP32], down_proj_acc_iter_4_outer_l0: pl.Tensor[[16, 5120], pl.FP32], mlp_chunk_bf16_0: pl.Tensor[[16, 64], pl.BFLOAT16], o0_3: pl.Scalar[pl.INDEX], w_down_0: pl.Tensor[[25600, 5120], pl.BFLOAT16]) -> pl.Tensor[[16, 5120], pl.FP32]:
        pl.comm.aic_initialize_pipe()
        for dob_0_in, (down_proj_acc_iter_4_outer_l1,) in pl.parallel(0, 8, 1, init_values=(down_proj_acc_iter_4_outer_l0,)):
            ...
            w_down_chunk_0__h0: pl.Tensor[[32, 64], pl.BFLOAT16] = pl.comm.tpop_from_aiv(0)
            w_down_chunk_0__h1: pl.Tensor[[32, 64], pl.BFLOAT16] = pl.comm.tpop_from_aiv(1)
            w_down_chunk_0__tmp: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.tensor.create(__list__(64, 64), dtype=pl.BFLOAT16)
            w_down_chunk_0__mid: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.tensor.assemble(w_down_chunk_0__tmp, w_down_chunk_0__h0, __list__(0, 0))
            pl.comm.tfree_to_aiv(0)
            w_down_chunk_0: pl.Tensor[[64, 64], pl.BFLOAT16] = pl.tensor.assemble(w_down_chunk_0__mid, w_down_chunk_0__h1, __list__(32, 0))
            pl.comm.tfree_to_aiv(1)
            ...
            __half0__: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.tensor.view(_t51, __list__(8, 64), __list__(0, 0))
            __half1__: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.tensor.view(_t51, __list__(8, 64), __list__(8, 0))
            pl.comm.tpush_to_aiv(__half0__, 0)
            pl.comm.tpush_to_aiv(__half1__, 1)
        return down_proj_acc_iter_4_outer_l1_rv
    @pl.function(type=pl.FunctionType.InCore)
    def qwen3_decode_layer_incore_6_aiv(self, dob_0_out: pl.Scalar[pl.INDEX], down_proj_acc_1: pl.Tensor[[16, 5120], pl.FP32], down_proj_acc_iter_2: pl.Tensor[[16, 5120], pl.FP32], down_proj_acc_iter_4_outer_l0: pl.Tensor[[16, 5120], pl.FP32], mlp_chunk_bf16_0: pl.Tensor[[16, 64], pl.BFLOAT16], o0_3: pl.Scalar[pl.INDEX], w_down_0: pl.Tensor[[25600, 5120], pl.BFLOAT16], AIV_IDX: pl.Scalar[pl.INDEX]) -> pl.Tensor[[16, 5120], pl.FP32]:
        pl.comm.aiv_initialize_pipe()
        for dob_0_in, (down_proj_acc_iter_4_outer_l1,) in pl.parallel(0, 8, 1, init_values=(down_proj_acc_iter_4_outer_l0,)):
            d0_0: pl.Scalar[pl.INDEX] = (0 + (dob_0_out * 8 + dob_0_in) * 1) * 64
            down_prev_0: pl.Tensor[[8, 64], pl.FP32] = pl.tensor.view(down_proj_acc_iter_4_outer_l1, [8, 64], [0, d0_0])
            w_down_chunk_0: pl.Tensor[[32, 64], pl.BFLOAT16] = pl.tensor.view(w_down_0, [32, 64], [o0_3 + AIV_IDX * 32, d0_0])
            pl.comm.tpush_to_aic(w_down_chunk_0, AIV_IDX)
            _t51: pl.Tensor[[8, 64], pl.BFLOAT16] = pl.comm.tpop_from_aic(AIV_IDX)
            down_next_0: pl.Tensor[[8, 64], pl.FP32] = pl.tensor.add(down_prev_0, _t51)
            pl.comm.tfree_to_aic(AIV_IDX)
            down_proj_acc_6: pl.Tensor[[16, 5120], pl.FP32] = pl.tensor.assemble(down_proj_acc_iter_4_outer_l1, down_next_0, [0 + AIV_IDX * 8, d0_0])
            down_proj_acc_iter_4_outer_l1_rv: pl.Tensor[[16, 5120], pl.FP32] = pl.yield_(down_proj_acc_6)
        return down_proj_acc_iter_4_outer_l1_rv
