...
def prefill_c1a_full(
    ...
    raise NotImplementedError("prefill_c1a_full kernel body is assigned independently")
...
if __name__ == "__main__":
    ...
    run_attention_golden(golden_prefill_c1a_full, ratio=1, mode="full")
