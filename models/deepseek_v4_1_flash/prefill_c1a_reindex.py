...
def prefill_c1a_reindex(
    ...
    raise NotImplementedError("prefill_c1a_reindex kernel body is assigned independently")
...
if __name__ == "__main__":
    ...
    run_attention_golden(golden_prefill_c1a_reindex, ratio=1, mode="reindex")
