...
# -----------------------------------------------------------------------------------------------------------
"""Continuous-batch decode C2A reuse attention."""
...
def decode_c2a_reuse(
    ...
    raise NotImplementedError("decode_c2a_reuse kernel body is assigned independently")


__all__ = ["golden_decode_c2a_reuse", "decode_c2a_reuse"]


if __name__ == "__main__":
    from models.deepseek_v4_1_flash._golden_smoke import run_attention_golden

    run_attention_golden(golden_decode_c2a_reuse, ratio=2, mode="reuse")
