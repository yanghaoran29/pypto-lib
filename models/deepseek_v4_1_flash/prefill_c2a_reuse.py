...
def prefill_c2a_reuse(
    ...
    raise NotImplementedError("prefill_c2a_reuse kernel body is assigned independently")


__all__ = ["golden_prefill_c2a_reuse", "prefill_c2a_reuse"]


if __name__ == "__main__":
    from models.deepseek_v4_1_flash._golden_smoke import run_attention_golden

    run_attention_golden(golden_prefill_c2a_reuse, ratio=2, mode="reuse")
