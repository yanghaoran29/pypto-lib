...
def expert_shared(
    ...
    for mt in pl.parallel(N_MTILES):
        ...
        for nb_idx in pl.parallel(0, MOE_INTER // MM_INTER_TILE, 1):
        ...
        for nb_idx in pl.parallel(0, MOE_INTER // (ACT_GATE_INNER * ACT_INTER_TILE), 1):
            with pl.at(level=pl.Level.CORE_GROUP, name_hint="sh_gate_up_act"):
        ...
        for db_idx in pl.parallel(0, D // D_OUT_TILE, 1):
            with pl.at(level=pl.Level.CORE_GROUP, name_hint="sh_w2_mm"):
        ...
        for db_idx in pl.parallel(0, D // (W2_ACT_INNER * D_OUT_TILE_ACT), 1):
            with pl.at(level=pl.Level.CORE_GROUP, name_hint="sh_w2_act"):
