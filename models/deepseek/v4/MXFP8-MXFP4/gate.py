...
def gate(
    ...
    for gb_idx in pl.parallel(0, active_gate_tiles * GATE_N_BLOCKS, 1):
    ...
    if layer_id < N_HASH_LAYERS:
        for th_idx in pl.parallel(0, active_route_tiles, 1):
        ...
        for ts_idx in pl.parallel(0, active_route_tiles, 1):
