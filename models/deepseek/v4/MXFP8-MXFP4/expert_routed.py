    ...
    for local_i in pl.parallel(N_LOCAL_EXPERTS):
        ...
        for t in pl.parallel(n_tiles):
            ...
            with pl.manual_scope():
                ...
                for gate_tid in pl.parallel(0, MOE_INTER // (MM_GATE_INNER * MM_INTER_TILE), 1):
                    with pl.at(level=pl.Level.CORE_GROUP, name_hint="exp_gate_mm"):
                        nb_idx = gate_tid
                ...
                for up_tid in pl.parallel(0, MOE_INTER // (MM_GATE_INNER * MM_INTER_TILE), 1):
                    with pl.at(level=pl.Level.CORE_GROUP, name_hint="exp_up_mm"):
                        nb_idx = up_tid
                        n_base = nb_idx * (MM_GATE_INNER * MM_INTER_TILE)
                        for ng in pl.range(MM_GATE_INNER):
                            n0 = n_base + ng * MM_INTER_TILE
                ...
                for act_tid in pl.parallel(0, MOE_INTER // (ACT_GATE_INNER * ACT_INTER_TILE), 1):
                    with pl.at(level=pl.Level.CORE_GROUP, name_hint="exp_gate_up_act"):
                        nb_idx = act_tid
                ...
                with pl.at(level=pl.Level.CORE_GROUP, name_hint="exp_h_q") as hq_tid:
                    ...
                    for k1 in pl.pipeline(0, MOE_INTER, QUANT_TILE, stage=2):
                        ...
                        eh_q_half = pl.cast(pl.cast(eh_q_i32, target_type=pl.FP32), target_type=pl.FP16, mode="round")
                ...
                for w2_tid in pl.parallel(0, D // (W2_INNER * D_OUT_TILE), 1):
                    with pl.at(level=pl.Level.CORE_GROUP, name_hint="exp_w2_mm"):
                        db_idx = w2_tid
