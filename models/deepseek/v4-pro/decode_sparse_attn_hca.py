...
def sparse_attn_hca(
    ...
    with pl.spmd(T // VALID_TOKEN_TILE, name_hint="build_valid", allow_early_resolve=True) as valid_tid:
    ...
    with pl.spmd(T * SPARSE_BLOCKS, name_hint="qk_pv", allow_early_resolve=True, deps=[gather_tid]) as qk_tid:
    ...
    with pl.manual_scope():
        for g in pl.parallel(O_GROUPS):
            ...
            with pl.spmd(
                PA_NFRAGS,
                name_hint="proj_a_mm", allow_early_resolve=True,
                deps=[merge_tid],
            ) as pa_tid:
            ...
            with pl.spmd(
                PB_DCHUNKS,
                name_hint="proj_b_mm", allow_early_resolve=True,
                deps=[pa_tid],
            ) as pb_tid:
    ...
    with pl.spmd(
        ...
        name_hint="proj_b_act", allow_early_resolve=True,
