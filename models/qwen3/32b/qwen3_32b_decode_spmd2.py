...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=False,
        help=(
            "On golden mismatch: save device outputs under data/actual/ and tiered "
            "mismatch PNGs under report/ (golden-tiered-validation color tiers)."
        ),
    )
    ...
    result = run(
        ...
        config=RunConfig(
            rtol=3e-3,
            atol=3e-3,
            mismatch_heatmap=args.mismatch_heatmap,
