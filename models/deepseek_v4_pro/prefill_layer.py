...
def prefill_layer_core(
    ...
    idx_kv_cache: pl.InOut[
        pl.Tensor[[PREFILL_IDX_CACHE_BLOCKS_DYN, BLOCK_SIZE, 1, IDX_HEAD_DIM], pl.FP8E4M3FN]
    ],
...
def l3_prefill_layer(
    ...
    csa_idx_wq_b_scale: pl.Tensor[
        [N_RANKS, Q_LORA // MX_GROUP, IDX_N_HEADS * IDX_HEAD_DIM],
        pl.FP8E8M0,
    ],
    ...
    idx_kv_cache: pl.InOut[
        pl.Tensor[
            [N_RANKS, PREFILL_IDX_CACHE_BLOCKS_DYN, BLOCK_SIZE, 1, IDX_HEAD_DIM],
            pl.FP8E4M3FN,
        ]
    ],
