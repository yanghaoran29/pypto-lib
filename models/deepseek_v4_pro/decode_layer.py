...
def decode_layer(
    ...
    csa_idx_wq_b: pl.Tensor[[Q_LORA, CSA_IDX_N_HEADS * CSA_IDX_HEAD_DIM], pl.FP8E4M3FN],
    csa_idx_wq_b_scale: pl.Tensor[
        [Q_LORA // MX_GROUP, CSA_IDX_N_HEADS * CSA_IDX_HEAD_DIM],
        pl.FP8E8M0,
        pl.MX_B_NN,
    ],
    ...
    idx_kv_cache: pl.InOut[
        pl.Tensor[[CSA_IDX_CACHE_BLOCK_NUM, BLOCK_SIZE, 1, CSA_IDX_HEAD_DIM], pl.FP8E4M3FN]
    ],
    ...
    if layer_id < ALT_START:
        if LEAD_RATIO == 0:
            attention_swa(
                ...
                wkv, wkv_scale, gamma_cq, gamma_ckv, freqs_cos, freqs_sin,
                kv_cache,
...
def l3_decode_layer(
    ...
    wq_a_scale: pl.Tensor[[N_RANKS, D // MX_GROUP, Q_LORA], pl.FP8E8M0],
    wq_b: pl.Tensor[[N_RANKS, Q_LORA, H * HEAD_DIM], pl.FP8E4M3FN],
    wq_b_scale: pl.Tensor[[N_RANKS, Q_LORA // MX_GROUP, H * HEAD_DIM], pl.FP8E8M0],
    wkv: pl.Tensor[[N_RANKS, D, HEAD_DIM], pl.FP8E4M3FN],
    wkv_scale: pl.Tensor[[N_RANKS, D // MX_GROUP, HEAD_DIM], pl.FP8E8M0],
    ...
    wo_a_scale: pl.Tensor[
        [N_RANKS, O_GROUPS * (O_GROUP_IN // MX_GROUP), O_LORA],
        pl.FP8E8M0,
    ],
    wo_b: pl.Tensor[[N_RANKS, O_GROUPS * O_LORA, D], pl.FP8E4M3FN],
    wo_b_scale: pl.Tensor[[N_RANKS, (O_GROUPS * O_LORA) // MX_GROUP, D], pl.FP8E8M0],
    ...
    csa_idx_wq_b: pl.Tensor[[N_RANKS, Q_LORA, CSA_IDX_N_HEADS * CSA_IDX_HEAD_DIM], pl.FP8E4M3FN],
    csa_idx_wq_b_scale: pl.Tensor[
        [N_RANKS, Q_LORA // MX_GROUP, CSA_IDX_N_HEADS * CSA_IDX_HEAD_DIM],
        pl.FP8E8M0,
    ],
    ...
    idx_kv_cache: pl.InOut[
        pl.Tensor[[N_RANKS, CSA_IDX_CACHE_BLOCK_NUM, BLOCK_SIZE, 1, CSA_IDX_HEAD_DIM], pl.FP8E4M3FN]
    ],
    idx_kv_scale: pl.InOut[
...
def golden_decode_layer_swa(tensors):
    ...
    for r in range(N_RANKS):
        golden_attention_swa({
            ...
            "wq_a": tensors["wq_a"][r],
            "wq_a_scale": tensors["wq_a_scale"][r],
            "wq_b": tensors["wq_b"][r],
            "wq_b_scale": tensors["wq_b_scale"][r],
            "wkv": tensors["wkv"][r],
            "wkv_scale": tensors["wkv_scale"][r],
            ...
            "wo_a": tensors["wo_a"][r],
            "wo_a_scale": tensors["wo_a_scale"][r],
            "wo_b": tensors["wo_b"][r],
...
def build_tensor_specs(
    ...
    attention_specs = [
        ...
        ("wo_a_scale", active_specs["wo_a_scale"]),
